...
#                   VERSION HISTORY
# ===================================================
# Version 0.9.5                   Posted Sep 16, 2014
#  - Able to at least start webdriver
...
class SpotifyScraper:
    def __init__(self):
        ...
        self.driver = None
        self.window = Display(visible=False)
    ...
    def connect(self):
        ...
        print 'This is not weird lol'

        self.window.start()
        self.driver = webdriver.Chrome(chrome_options=options, service_args=["--verbose", "--log-path=webdriver.log"])
        print 'This is weird ...'
